...
#> 1: Fold1   0.5389785   0.7 0.003092562 multinomial        class        TRUE
#> 2: Fold2   0.5101215   0.7 0.003092562 multinomial        class        TRUE
#> 3: Fold3   0.5309140   0.7 0.003092562 multinomial        class        TRUE
...
#> 1: Fold1   0.5268817 0.006548214  0.90 multinomial        class        TRUE
#> 2: Fold2   0.4993252 0.001710793  0.65 multinomial        class        TRUE
#> 3: Fold3   0.5268817 0.038236018  0.10 multinomial        class        TRUE
...
head(validator_results)
#>     fold performance     alpha      lambda      family type.measure standardize
#> 1: Fold1   0.5389785 0.7000000 0.004817737 multinomial        class        TRUE
#> 2: Fold2   0.5168691 0.4178147 0.017108341 multinomial        class        TRUE
#> 3: Fold3   0.5241935 0.1000000 0.041963982 multinomial        class        TRUE
...
#> 1:  Fold1   0.5456989 0.005314924   0.9 multinomial        class        TRUE
#> 2:  Fold2   0.4736842 0.005314924   0.9 multinomial        class        TRUE
#> 3:  Fold3   0.5040323 0.005314924   0.9 multinomial        class        TRUE
